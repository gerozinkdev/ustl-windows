...
void TestUTF8 (void)
{
    ...
    cout.format ("%lu differences between src and decoded.\n", nDiffs);
    ...
    cout.format ("Values[%lu]:", ws.length());
	...
	cout.format (" %lu", distance (ws.begin(), k.base()));
    cout << endl;

    cout.format ("Erasing character %lu: ", ws.length() - 1);
