...
{
    bitset<30> bs1;
    cout.format ("bitset<%lu> bs1: capacity() = %lu, sizeof() = %lu\n", bs1.size(), bs1.capacity(), sizeof(bs1));
    cout << bs1 << endl;
    bs1.set();
    bs1.set (6, false);
    cout << bs1 << endl;
    ...
    cout.format ("bitset<%lu> bs2: capacity() = %lu, sizeof() = %lu\n", bs2.size(), bs2.capacity(), sizeof(bs2));
    cout << bs2;
    bs2.set (34, 40, 13);
    cout << "\nbs2.set(34,40,13)\n";
    cout << bs2;
    ...
    cout.format ("bitset<%lu> bs3: capacity() = %lu, sizeof() = %lu\n", bs3.size(), bs3.capacity(), sizeof(bs3));
